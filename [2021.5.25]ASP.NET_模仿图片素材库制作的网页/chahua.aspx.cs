...
public partial class chahua : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!Page.IsPostBack)
        {
            ...
            using (conn)
            {
                ...
                cmd.CommandText = "select top 12 tagtext,addpath,uploadby,id from pic_list where tag='chahua' order by id desc";
