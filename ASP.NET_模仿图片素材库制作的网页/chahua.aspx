<%@ Page Title="" Language="C#" MasterPageFile="~/indexMasterPage.master" AutoEventWireup="true" CodeFile="chahua.aspx.cs" Inherits="chahua" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="wel2" Runat="Server">
    <!--欢迎标语2-->
    Pixabay拥有300000张优质插画素材，让你轻松应对各种设计场景
</asp:Content>

<asp:Content ID="Content4" ContentPlaceHolderID="hots" Runat="Server">
    <!--热门搜索-->
    热门搜索： 花, 背景, 科技, 风景, 人物, 插画, 动漫, 城市
</asp:Content>
